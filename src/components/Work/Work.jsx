  ...
  return (
    <section id="work" className="min-h-screen bg-[#0d0d0d] text-white py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold mb-8 sm:mb-12 md:mb-16 text-center">
          Work & <span className="text-gray-500">Practice</span>
        </h2>

        {/* LeetCode Section */}
        <div className="bg-[#1a1a1a] rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 mb-8 sm:mb-12">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            ...
            <div className="flex-1">
              <h3 className="text-2xl sm:text-3xl font-bold">LeetCode Stats</h3>
            ...
            {leetcodeData && (
              <a
                ...
                className="px-4 sm:px-6 py-2 sm:py-3 bg-yellow-500 text-black rounded-lg font-semibold text-sm sm:text-base hover:bg-yellow-400 transition-colors"
              >
                View Profile →
              </a>
            )}
        ...
        {GITHUB_USERNAME !== "YOUR_GITHUB_USERNAME" && (
          <div className="bg-[#1a1a1a] rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <div className="flex-1">
                <h3 className="text-2xl sm:text-3xl font-bold">GitHub Activity</h3>
                <p className="text-sm sm:text-base text-gray-400">Open source contributions & projects</p>
              </div>
              <a
                href={`https://github.com/${GITHUB_USERNAME}`}
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 sm:px-6 py-2 sm:py-3 bg-white text-black rounded-lg font-semibold text-sm sm:text-base hover:bg-gray-200 transition-colors"
              >
                View Profile →
              </a>
            </div>
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-8 sm:mb-12">
                  <div className="bg-[#0d0d0d] rounded-lg sm:rounded-xl p-4 sm:p-6 text-center">
                    <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-400">{githubData.publicRepos}</p>
                    <p className="text-gray-400 mt-2">Public Repos</p>
                  </div>
                  <div className="bg-[#0d0d0d] rounded-lg sm:rounded-xl p-4 sm:p-6 text-center">
                    <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-purple-400">{githubData.followers}</p>
